...
def gtan_main_n_layers(feat_df, graph, train_idx, test_idx, labels, args, cat_features):
    n_layers = [2, 4, 6, 8, 10]  # 示例值，实际值根据你的实验设置
    ...
    for i in n_layers:
        ...
        # 在所有实验完成后，调用绘图函数
    print(results)
    plot_results(results, 'N_layers_experiment.png')
